...
final class FocusCommandTest: XCTestCase {
    ...
    func testParse() {
        ...
        var expected = FocusCmdArgs(rawArgs: [], cardinalOrDfsDirection: .cardinal(.left))
    ...
    func testFocusAlongTheContainerOrientation() {
        ...
        FocusCommand.new(cardinalOrDfsDirection: .cardinal(.right)).run(.defaultEnv, .emptyStdin)
        assertEquals(focus.windowOrNil?.windowId, 2)
    }
    ...
    func testFocusAcrossTheContainerOrientation() {
        ...
        assertEquals(focus.windowOrNil?.windowId, 2)
        FocusCommand.new(cardinalOrDfsDirection: .cardinal(.up)).run(.defaultEnv, .emptyStdin)
        assertEquals(focus.windowOrNil?.windowId, 2)
        FocusCommand.new(cardinalOrDfsDirection: .cardinal(.down)).run(.defaultEnv, .emptyStdin)
        assertEquals(focus.windowOrNil?.windowId, 2)
    }
    ...
    func testFocusNoWrapping() {
        ...
        assertEquals(focus.windowOrNil?.windowId, 1)
        FocusCommand.new(cardinalOrDfsDirection: .cardinal(.left)).run(.defaultEnv, .emptyStdin)
        assertEquals(focus.windowOrNil?.windowId, 1)
    }
    ...
    func testFocusWrapping() {
        ...
        assertEquals(focus.windowOrNil?.windowId, 1)
        var args = FocusCmdArgs(rawArgs: [], cardinalOrDfsDirection: .cardinal(.left))
...
extension FocusCommand {
    static func new(cardinalOrDfsDirection: CardinalOrDfsDirection) -> FocusCommand {
        FocusCommand(args: FocusCmdArgs(rawArgs: [], cardinalOrDfsDirection: cardinalOrDfsDirection))
    }
}
